 ...
 * carrying the line it is compared against. The price table prices exactly
 * these zones and registers under the same scene id, but the page is what puts
 * it after this one: a section component owns one screen and no more (see
 * `app/[locale]/page.tsx`).
 */
